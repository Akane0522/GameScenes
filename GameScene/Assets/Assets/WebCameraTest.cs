...
public class WebCameraTest : MonoBehaviour
{
    ...
    */
    ...
    void Start()
    {
        String File_path0 = Application.dataPath + "/SavedScreen";
        String File_path1 = Application.dataPath + "/BufScreen";
        String File_path2 = Application.dataPath + "rectScreen";
    ...
    Texture2D getCenterClippedTexture(Texture2D texture)
    {
        ...
        String file_path = Application.dataPath + "/rectScreen";
    ...
    public void Process(string filename)
    {
        ...
        String file_path = Application.dataPath + "/BufScreen";
